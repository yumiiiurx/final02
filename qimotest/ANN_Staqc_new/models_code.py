...
class CodeMF:
    ...
    def params_adjust(self, dropout1=0.5, dropout2=0.5, dropout3=0.5, dropout4=0.5, dropout5=0.5,
                      Regularizer=0.01, num=100, seed=42):
        """
        参数调整函数，用于设置模型的参数。

        Args:
            dropout1: 第一个dropout参数
            dropout2: 第二个dropout参数
            dropout3: 第三个dropout参数
            dropout4: 第四个dropout参数
            dropout5: 第五个dropout参数
            Regularizer: 正则化参数
            num: 数量参数
            seed: 随机种子参数
